...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__card_card__ = __webpack_require__(98);
...
var HomePage = (function () {
    ...
    HomePage.prototype.showCardPage = function () {
...
HomePage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-home',template:/*ion-inline-start:"C:\MAMP\htdocs\N322\cards\src\pages\home\home.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>\n        Homework 2\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n <p id="loadPage"></p>\n\n  <button ion-button (click)="showCardPage()" color="dark"  >\n      View Cards\n  </button>\n\n</ion-content>\n'/*ion-inline-end:"C:\MAMP\htdocs\N322\cards\src\pages\home\home.html"*/
    }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__pages_card_card__ = __webpack_require__(98);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
MyApp = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({template:/*ion-inline-start:"C:\MAMP\htdocs\N322\cards\src\app\app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"C:\MAMP\htdocs\N322\cards\src\app\app.html"*/
    }),
...
var CardPage = (function () {
    ...
    CardPage.prototype.deleteCard = function (card) {
        var index = this.cards.indexOf(card);
        this.cards.splice(index, 1);
        this.arrayCount();
    };
    CardPage.prototype.clickShare = function (card) {
        var index = this.cards.indexOf(card);
        if (index > -1) {
            if (card.favorite) {
    ...
    CardPage.prototype.clickFaveorite = function (card) {
        var index = this.cards.indexOf(card);
        if (index > -1) {
            if (card.share) {
    ...
    CardPage.prototype.arrayCount = function () {
...
CardPage = __decorate([
    ...
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-card',template:/*ion-inline-start:"C:\MAMP\htdocs\N322\cards\src\pages\card\card.html"*/'<!--\n  Generated template for the CardPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n    <ion-navbar>\n        <ion-title>Homework 2</ion-title>\n    </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n\n    <h1 id="arrayCount"></h1>\n\n    <ion-card *ngFor="let card of cards">\n        <img src="assets/img/{{card.imgPath}}">\n\n        <ion-card-content>\n\n            <ion-card-title>\n                {{card.title}}\n            </ion-card-title>\n\n            <p>{{card.desc}}</p>\n\n        </ion-card-content>\n\n        <ion-row>\n            <ion-col>\n                <button ion-button clear icon-start (click)="clickFaveorite(card)">\n                    <ion-icon [name]="(card.favorite ? \'heart\' : \'heart-outline\')"> Fav</ion-icon>\n                </button>\n            </ion-col>\n\n            <ion-col>\n                <button ion-button clear icon-start (click)="clickShare(card)">\n                    <ion-icon [name]="(card.shared ? \'ios-share\' : \'ios-share-outline\')"> Share</ion-icon>\n                </button>\n            </ion-col>\n\n            <ion-col>\n                <button ion-button icon-only color="danger" (click)="deleteCard(card)">\n                    <ion-icon name="trash"></ion-icon>\n                </button>\n            </ion-col>\n        </ion-row>\n\n    </ion-card>\n\n</ion-content>'/*ion-inline-end:"C:\MAMP\htdocs\N322\cards\src\pages\card\card.html"*/,
    }),
